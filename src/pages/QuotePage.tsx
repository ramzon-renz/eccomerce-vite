...
import { Send, Loader2, ShoppingCart, AlertCircle, Check } from "lucide-react";
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "Thank you for your request. Our team will contact you shortly with a detailed quote.",
      });
      clearCart();
      // Reset form
      setFormData({
      ...
      <main className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 bg-white">
          <div className="text-center mb-8">
            ...
            >
              Please fill out the form below to receive a detailed quote for
              your selected products. Our team will contact you within 24-48
              business hours.
            </motion.p>
          </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      >
                        <option value="no">
                          No, I will arrange my own installation
                        </option>
                        <option value="yes">
                          Yes, please include installation in the quote
                        </option>
                  ...
                  <>
                    ...
                    <div className="bg-blue-50 p-3 rounded-md mt-4 flex items-start">
                      ...
                      <p className="text-blue-800 text-xs">
                        ...
                        confirmed in your quote and may include additional costs
                        for customization, shipping, and installation if
                        requested.
                      </p>
                    </div>
                  </>
